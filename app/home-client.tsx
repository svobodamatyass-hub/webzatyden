...
const copy = {
  ...
  en: {
    ...
    valueKicker:"02 / WHAT YOU GET", valueTitle:"One team. One week. One finished website.", values:[
...
function QuoteBand({ quote, index, tone = "dark" }: { quote: { label: string; lead: string; accent: string }; index: number; tone?: "dark" | "light" }) {
  return (
    <aside className={`quote-band quote-${tone}`} aria-label={quote.label} data-reveal>
  ...
  return (
    <>
      ...
      <section className="section process-section" id="process">
        <div className="process-intro" data-reveal><span className="kicker">{t.processKicker}</span><h2><RichHeading text={t.processTitle} /></h2><p>{t.processText}</p></div>
      ...
      <QuoteBand quote={t.quotes[1]} index={2} tone="light" />
